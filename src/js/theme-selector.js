...
const btnSwitch = document.querySelector('#button-theme');
...
export function toggleThemeColors(e) {
    e.addEventListener('click', () => {
        ...
        btnSwitch.classList.remove(`theme-selector__button${currentTheme}`);
        ...
        btnSwitch.classList.add(`theme-selector__button${themeClass}`);
